...
#define LEFT_MOTOR_POL 		    1		// related to the duty cycle direction
#define RIGHT_MOTOR_POL 		1
#define LEFT_MOTOR_ENC_POL 	   1		// related to the signage of the encoder ticks 
#define RIGHT_MOTOR_ENC_POL		1

// TODO: Fill in physical propeties of robot
#define GEAR_RATIO              78.1  // gear ratio of motor

#define ENCODER_RES             20  // encoder counts per motor shaft revolution
#define WHEEL_DIAMETER          0.084   // diameter of wheel in meters

#define WHEEL_BASE              0.1562  // wheel separation distance in meters
